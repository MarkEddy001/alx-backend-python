...
This project is part of the Advanced Python course and focuses on learning and practicing variable annotations in Python. You will learn how to use type annotations to specify function signatures and variable types, understand duck typing, and validate your code with mypy.
...
2. Install pycodestyle and mypy
...
- `pycodestyle`: Configures pycodestyle for code linting.
- `mypy.ini`: Configures mypy for type checking.

## Usage

1. Open your project directory in your preferred code editor.
2. Run the following command to check your code with pycodestyle:
   ```sh
   pycodestyle .
